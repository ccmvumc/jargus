...
logger = logging.getLogger('jargus.reports.registry.progress')
...
DESCRIPTION = '''
This report summarizes CCM Registry activity as a set of plots and tables.
'''
